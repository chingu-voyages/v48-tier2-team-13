...
function DinosaurDetailsPage() {
  ...
  function handleFullDetails(){
    const hiddenDetails= document.getElementById("fullDetails").hidden = !detailsVisibility
  ...
  function handleLocationMap(){
    const hiddenMap= document.getElementById("locationMap").hidden = !mapVisibility
  ...
  return (
    <>
      ...
      <div className=" lg:ml-[3%] ml-[13%]">
       <h1 className="font-primary text-2xl text-secondary-500">{name.toUpperCase()}</h1>
      ...
      <div id="image" className="lg:mb-[5%] my-[5%]">
        ...
        <div className="bg-bg-dark w-80 lg:h-64 h-48 rounded-md pt-[10%] pl-[5%] text-text-light 
...
<div className="place-content-end lg:mt-0 mt-2 ">
  ...
  <h3 className="lg:ml-[65%] ml-[10%] w-[50%] text-secondary text-lg">Location map</h3>
...
<div className="text-secondary text-lg lg:ml-[3%] ml-[13%] mt-[10%] lg:mt-0 mb-[5%]  ">
        {description !== "N/A" ? <p className=" mr-[5%] lg:mr-[8%] leading-relaxed"> {description} </p> : <p>No description available.</p>}
        </div>
      <div id="fullDetails" className="pb-[5%] lg:pb-1" hidden>
        ...
        <div className=" rounded-lg shadow-lg  shadow-neutral-800 mr-[5%] h-full pt-[5%] pb-[5%] pl-[5%]"> 
          <h1 className="text-2xl text-secondary-500 font-primary">TYPE
          </h1> 
          <section>{typeOfDinosaur}</section>
          </div>
          
          <div className=" rounded-lg shadow-lg  shadow-neutral-800 lg:mr-[15%] mr-[5%] h-full py-[5%] pl-[5%]">
            <h1 className="text-2xl  text-secondary-500 font-primary" >SPECIES
              </h1>
              <section >{typeSpecies}
                </section> </div>
          ...
          <div className="relative rounded-lg shadow-lg  shadow-neutral-800 mr-[15%] h-full w-[90%]  ml-[5%] lg:ml-[3%] pt-[3%] pb-[5%] pl-[5%] lg:pl-[2%]">
            <h1 className="text-2xl  text-secondary-500 font-primary lg:my-0 my-[5%]">TAXONOMY</h1>
          ...
          <div className="relative rounded-lg shadow-lg  shadow-neutral-800 mr-[15%] h-full w-[90%]  ml-[5%] lg:ml-[3%] pt-[3%] pb-[5%] pl-[5%] lg:pl-[2%]">
            <h1 className="text-2xl  text-secondary-500 font-primary lg:my-0 my-[5%]">LIVED IN</h1>
            <div className="absolute lg:right-6 right-0 top-[10%] lg:top-6">
              <LivedIn/>
            </div>
            <section>
          ...
          <div className="relative rounded-lg shadow-lg  shadow-neutral-800 mr-[15%] h-full w-[90%] ml-[5%] lg:ml-[3%] pt-[3%] pb-[15%] lg:pb-[5%] pl-[5%] lg:pl-[2%]">
            <h1 className="text-2xl  text-secondary-500 font-primary">NAMED BY</h1>
        ...
        <div id="locationMap"className=" ml-5 lg:ml-[3%] mr-5 w-[90%] mt-[10%] lg:mt-[5%] mb-[5%]" hidden>
