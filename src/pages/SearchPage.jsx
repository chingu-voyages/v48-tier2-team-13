...
function SearchPage() {
  ...
  return (
    <div className="bg-bg-primary lg:mx-[10%] sm:mx-[5%]">
      <div className="relative my-10">
        ...
        <div id= "closeIcon" className="absolute right-6 top-3 mr-[10%] lg:mr-[3%] z-40">
          {closeIcon ? (
            ""
          ) : (
        ...
        <div id="filterIcon" className="absolute right-6 top-2 z-40">
          <Link className="hover:brightness-150" onClick={handleFilterDisplay} >
      ...
      <div className="grid md:grid-cols-4 md:gap-x-6 mb-[5%]">
        ...
        <div>
          ...
          >
            ...
            <option value="herbivorous"className="hover:bg-primary">Herbivorous</option>
